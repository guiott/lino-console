...
/* LLS -> HLS values coming from Low Level Supervisor
 ...
 obst    Obstacles distances
 lPwrOff Power Off command from LLS to HLS
*/
 LLS={batV:[0,0], 
      temp:[0,0],
      obst:[255,255,255,255,255,255,255],
      lPwrOff:0
      };
...
{//sending loopback joysticks values for testing purposes
      ...
      dsNav.velInt[0] = joy.RY * 1.4;
      dsNav.velInt[1] = joy.RY * 1.4;
      dsNav.velInt[2] = joy.RY * 1.4;
      dsNav.velInt[3] = joy.RY * 1.4;
      LLS.temp[0] = 35;
      LLS.temp[1] = 25;
      LLS.batV[0] = 50;
      LLS.batV[1] = 75;
